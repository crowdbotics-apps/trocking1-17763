"""trocking1_17763 URL Configuration
...
admin.site.site_header = "Trocking1"
admin.site.site_title = "Trocking1 Admin Portal"
admin.site.index_title = "Trocking1 Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Trocking1 API",
        default_version="v1",
        description="API documentation for Trocking1 App",
    ),
    public=True,
